...
PB_BIND(socket_message_SystemInformationRequest, socket_message_SystemInformationRequest, AUTO)


PB_BIND(socket_message_SystemInformationResponse, socket_message_SystemInformationResponse, AUTO)


PB_BIND(socket_message_CorrelationRequest, socket_message_CorrelationRequest, 2)


PB_BIND(socket_message_CorrelationResponse, socket_message_CorrelationResponse, 4)
...
PB_BIND(socket_message_ControllerData, socket_message_ControllerData, AUTO)
...
PB_BIND(socket_message_Message, socket_message_Message, 4)
